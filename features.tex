...
removing or adding features based on how it affects the model's accuracy on held-out data, 
or with an objective regularization penalty such as $L_1$ (\cref{sec:reg}).
...
such as trees \citep[in syntactic parsing: e.g.,][]{mcdonald-05} 
