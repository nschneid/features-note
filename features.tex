...
particular $x$ and $y$ pairs. The main use of data is to learn which features are most effective 
...
should not affect predictive performance, and may make the model more interpretable\futureversion{\nss{(\cref{sec:interp})}}.
