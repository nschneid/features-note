...
\end{center}
%
Not all sequence modeling frameworks fit neatly in the above table: e.g., model families combining 
generative and discriminative components \citep{berg-kirkpatrick-10,ammar-14}.
